          ...
          <div className="flex flex-col items-center">
            {editing ? (
              <form onSubmit={handleSave} className="w-full">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="firstName"
                    name="firstName"
                    className="shadow appearance-none border border-orange-500 rounded w-full py-2 px-3 text-gray-200 bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-orange-500"
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 mb-2">
                  Płeć: {profileData?.gender}
                </p>
                <p className="text-gray-400 mb-2">Opis: {profileData?.bio}</p>
                <button
                  onClick={() => setEditing(true)}
                  className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 mt-4"
                >
                  Edytuj profil
                </button>
              </div>
